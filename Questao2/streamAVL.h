...
/* públicas (mantidas) */
Stream *CriarStream(); /* se não usar, pode remover a declaração */
...
/* “questões” (mantidas) */
void mostrarProgDeCatDeStream(Categorias *categoria, Stream *stream,
                              char *nomeCategoria, char *nomeStream, Programas *programas);
...
/* opcional (compat): usado só se precisar do maior à direita */
